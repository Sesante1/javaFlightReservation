...
package javaflightreservation;


import users.registrationForm;
import admins.adminDashboard;
import admins.profilePicture;
...
public class LogIn extends javax.swing.JFrame {
    ...
    public static boolean loginAcc(String username, String password){
        ...
        try{
            ...
            if (resultSet.next()){
                ...
                session.setImagePath(resultSet.getString("profile"));
                session.setOldpath(resultSet.getString("profile"));
                session.setPath(resultSet.getString("profile"));
                session.setDestination((resultSet.getString("profile")));
                return true;
            } else{
                return false;
            }
    ...
    private void initComponents() {
        ...
        jLabel1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/backGroundImage/undraw_Access_account_re_8spm.png"))); // NOI18N
        ...
        getContentPane().add(jPanel2, new org.netbeans.lib.awtextra.AbsoluteConstraints(520, 0, 420, 450));
